...
@Component({
  selector: 'cafe-subscriptions-organism',
  templateUrl: './cafe-subscriptions.component.html',
  styleUrls: ['./cafe-subscriptions.component.scss']
})

export class CafeSubscriptionsOrganism {

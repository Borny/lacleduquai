...
import { ModalResidenceManagerPage } from './modal-studio-manager/modal-residence-manager.page';

@Component({
  selector: 'organism-studio-admin',
  templateUrl: './organism-studio-admin.component.html',
  styleUrls: ['./organism-studio-admin.component.scss'],
})
export class OrganismStudioAdminComponent implements OnInit {
  // RESIDENCE

...
@Component({
  ...
  templateUrl: './take-away-admin-organism.component.html',
  styleUrls: ['./take-away-admin-organism.component.scss'],
})
export class TakeAwayAdminOrganismComponent implements OnInit {
